...
//
//    AbstractConfusionMatrix(BiMap<T, Integer> labelIndexMap, SimpleMatrix mat, Comparator<T> labelOrder, Function<T, String> labelFormatter) {
...
//    }
    ...
    public abstract double getCount(T actual, T predicted);
...
//    }
//
//    public double getCount(T actual, T predicted) {
//        final int y = labelIndexMap.get(actual);
//        final int x = labelIndexMap.get(predicted);
//        return mat.get(y, x);
//    }

    public double getPredictedCountFor(T predictedLabel) {
        double sum = 0;
    ...
    public double getActualCountFor(T actualLabel) {
        double sum = 0;
...
//        };
//
//        final AbstractConfusionMatrix<D> dstMatrix = mapLabels(new Function<T, D>() {
//            @Nullable
//            @Override
...
//     * @return
//     */
//    public <D> AbstractConfusionMatrix<D> mapLabels(
...
//            }
//        }
//        return new AbstractConfusionMatrix<D>(dstLabelIndexMap, targetMat, dstLabelOrder, targetLabelFormatter);
//    }
//
//    @Override
