...
/**
 * An annotator which removes all xml tags (as identified by the tokenizer) and possibly selectively
 * keeps the text between them. Can also add sentence ending markers depending on the xml tag.
 *
 * @author John Bauer
 */
public class CleanXmlAnnotator2 implements Annotator {
    ...
    /**
     * This regular expression tells us which tags end a sentence... for example, &lt;p&gt; would be
     * a great candidate
     */
    ...
    /**
     * This setting allows handling of flawed XML. For example, a lot of the news articles we parse
     * go: <br> &lt;text&gt; <br> &lt;turn&gt; <br> &lt;turn&gt; <br> &lt;turn&gt; <br>
     * &lt;/text&gt; <br> ... eg, no closing &lt;/turn&gt; tags.
     */
