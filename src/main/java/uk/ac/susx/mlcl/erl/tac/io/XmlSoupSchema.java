 ...
 */
public class XmlSoupSchema extends Schema implements XmlSoupModels {
...
//        setPrefix("html");
        ...
        elementType("root", M_HTML, M_ROOT, 0);
        elementType("doc", M_PCDATA | M_INLINE | M_BLOCK, M_HTML | M_BODY, 0);
